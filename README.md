...
A ideia do projeto é construir um site/fórum para espalhar o "Mito da Baleia" pelo Fundão, atualizações serão feitas com o passar do tempo. Novas páginas, novas funcionalidades, etc. Principalmente melhorar a segurança dessa senha !!
